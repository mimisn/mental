  ...
  this.validateRequiredFields = function(options) {
    if (this.requiredField) {
      ...
      for (index in this.requiredFields) {
        var field_id = this.requiredFields[index].id; // id does not contain loop sysManagement prefix...?
    ...
    $.fn.vindicate = function() {
      ...
      if (action == "init") {
        ...
        for (index in fields) {
          ...
          vin.fields[field.fieldId] = field; // sysManagement prefix to maintain form ordering
        }
        ...
        //$form_this.data("vindicate-sysManagement", form_index);
        // }
